...
nsdq = pd.read_csv('apps/data/NASDAQcompanylist.csv')
...
layout = html.Div([
    html.H1('Stock Ticker Dashboard', style={'padding-left':'120px', 'margin':'0px'}),
    html.Div([
    ...
    ], style={'display':'inline-block', 'verticalAlign':'top', 'width':'30%', 'padding-left':'120px'}),
    html.Div([
    ...
    dcc.Graph(
        id='my_graph',
        style={'border':'outset #cf944b', 'border-radius': '10px', 'padding-left':'60px', 'padding-right':'60px'},
        figure={
            'data': [
                {'x': [1,2], 'y': [3,1]}
            ]
